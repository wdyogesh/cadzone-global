...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-md-10">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Company Details</h6>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                <form action="{{ route('company.update', $company) }}" method="post" class="form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    autofocus="none" value="{{ $company->name }}" name="name" id="name"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="contact_person" id="contact_person" value="{{  $company->contact_person }}"
                ...
                <div class="row">
                    ...
                    <input type="text" value="{{ $company->office_contact }}" name="office_contact"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{ $company->hr_contact }}" name="hr_contact" id="hr_contact"
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        name="address" id="address" rows="3">{{  $company->address }}</textarea>
                        @error('address')
                ...
                <div class="row">
                    ...
                    <select id="country" class="form-control-sm form-control @error('country') is-danger @enderror" name="country" id="country">
                        @foreach ($countries as $key =>$country)
                          <option value="{{ $key }}" {{ $company->country_id == $key ? 'Selected' : '' }}>{{ $country }}</option>
                        @endforeach
                    </select>
                    @error('country')
                ...
                <label for="" class="required">State</label>
                    <select class="form-control-sm form-control" name="state" id="state">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control-sm form-control" name="city" id="city">
                ...
                <div class="row">
                        <div class="col-md-12">
                            ...
                            rows="3">{{ $company->other_details }}</textarea>
                            @error('other_details')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img class="profile" width="60%" src="{{ url('company_logo/'.$company->company_logo) }}" alt="{{ $company->name }}">
                    </div>
                </div>
