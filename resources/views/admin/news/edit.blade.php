...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-md-10">
                    <h6 class="m-0 font-weight-bold text-primary">Update News Details</h6>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                <form action="{{ route('news.update', $news) }}" method="post" class="form" enctype="multipart/form-data">
                 @csrf
                 @method('PUT')
                <div class="row">
                    ...
                    autofocus="none" value="{{ $news->title }}" title="title" id="title"
                    name="title"
                    class="form-control-sm form-control @error('title') is-danger @enderror" placeholder="Enter News title">
                    @error('title')
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                        <label for="">Upload Image One</label>
                        <input type="file" class="form-control-sm form-control-file"
                        name="image" id="image" placeholder="Upload News Images"
                        {{ old('image') }}
                    ...
                    <div class="col-md-4">
                        <img class="profile" width="60%" src="{{ url('news_images/'.$news->image) }}" alt="{{ $news->image }}">
                    </div>
                </div>
