...
@section('app_title', 'Create newsBoard')
...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-md-10">
                    <h6 class="m-0 font-weight-bold text-primary">Add New Board News</h6>
                </div>
                <div class="col-md-2 pull-right">
                    <a href="{{ route('newsBoard.index') }}" class="btn btn-primary btn-icon-split btn-sm">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                <form action="{{ route('newsBoard.store') }}" method="post" class="form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    <div class="form-group">
                        ...
                        name="news" id="news" rows="3">{{ old('news') }}</textarea>
                        @error('news')
