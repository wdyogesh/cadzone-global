            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        autofocus="none" value="{{ $employee->user['name'] }}" name="name" id="name"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="email" id="email" value="{{ $employee->user['email'] }}" readonly
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="mother_name" id="mother_name" value="{{ $employee->mother_name }}"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" value="{{ $employee->father_name }}" name="father_name"
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="present_phone" id="present_phone" value="{{ $employee->user['present_phone'] }}"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" value="{{ $employee->user['perma_number'] }}" name="perma_number"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" value="{{ $employee->emer_contact }}" name="emer_contact" id="emer_contact"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        <label for="" class="required">Post :</label>
                        <select class="form-control-sm form-control" name="role" id="role">
                        <option value="" disabled>Select</option>
                        ...
                        @error('role')
                        <div class="help-desk text-danger"> {{ $errors->first('role') }} </div>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        name="curr_adddress" id="curr_adddress" rows="3">{{ $employee->curr_adddress }}</textarea>
                        @error('curr_adddress')
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control-sm form-control" name="curr_state_id" id="state">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control-sm form-control" name="curr_city_id" id="city">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" value="{{ $employee->curr_pin_code }}" name="curr_pin_code" id="curr_pin_code"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        name="perma_address" id="perma_address" rows="3">{{ $employee->perma_address }}</textarea>
                        @error('perma_address')
                ...
                <div class="form-group col-md-3">
                    <label for="" class="required">State</label>
                    <select class="form-control-sm form-control" name="perma_state_id" id="state_one">
                ...
                <div class="form-group col-md-3">
                    <label for="" class="required">city</label>
                    <select class="form-control-sm form-control" name="perma_city_id" id="city_one">
                ...
                <div class="form-group col-md-3">
                    <label for="">Pin Code</label>
                    <input type="text" value="{{ $employee->perma_pin_code }}" name="perma_pin_code" id="perma_pin_code"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" value="{{ $employee->bank_number }}" name="bank_number" id="bank_number"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" value="{{ $employee->ifsc_code }}" name="ifsc_code" id="ifsc_code"
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" value="{{ $employee->pan_no }}" name="pan_no" id="pan_no"
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" value="{{ $employee->uan_no }}" name="uan_no" id="uan_no"
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" value="{{ $employee->esic_no }}" name="esic_no" id="esic_no"
