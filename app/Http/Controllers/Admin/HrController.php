...
class HrController extends Controller
{
    ...
    // Hr Controller for index section.
    ...
    {
        return view('admin.employee.create', ['countries' => $this->countries, 'blood_groups' => $this->blood_groups, 'off_sides' => $this->off_sides]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.employee.edit', ['countries' => $this->countries,
            'blood_groups' => $this->blood_groups, 'off_sides' => $this->off_sides, 'employee' => $employee]);
    }

    public function show($id)
    {
        $employee = Employee::with('currentCountry', 'currentCity', 'permaCountry', 'permaState', 'permaCity', 'user', 'currentState')->where('user_id', $id)->first();
        return view('admin.employee.show', ['countries' => $this->countries,
            'blood_groups' => $this->blood_groups, 'off_sides' => $this->off_sides, 'employee' => $employee]);
    }
