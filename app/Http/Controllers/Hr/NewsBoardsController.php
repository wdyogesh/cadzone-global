...
class NewsBoardsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hr.newsBoard.index', compact('newsboards'));
    }

    public function create()
    {
        return view('hr.newsBoard.create');
    }

    public function show(NewsBoards $newsBoards, $id)
    {
        $newsBoards = NewsBoards::find($id);
        return view('hr.newsBoard.show', compact('newsBoards'));
    }
    ...
    {
        $newsboards = NewsBoards::find($id);
        return view('hr.newsBoard.edit', compact('newsboards'));
    }
